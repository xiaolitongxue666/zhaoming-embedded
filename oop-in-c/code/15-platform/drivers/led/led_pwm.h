 ...
 * led_set_brightness dispatch 会调到这里. GPIO 子类不实现, 走父类默认
 * no-op. 应用层一行代码切实例就拿到对应能力.
 *
 * 子类底下只调 platform_pwm_xxx ops 表层接口, 跨 MCU 移植 0 改动.
 */

#ifndef DRIVERS_LED_LED_PWM_H
#define DRIVERS_LED_LED_PWM_H
