...
Linux 端 `gpio_on` 的实现还是 ch01 那一套（节选自 [`oop-in-c/code/07-function-pointer/linux-snippet/led_linux.c`](https://github.com/ZhaoChengBo/zhaoming-embedded/tree/master/oop-in-c/code/07-function-pointer/linux-snippet/led_linux.c)）：
