...
/**
  ******************************************************************************
  * @file    v_motor_base.h
  * @brief   垂直电机基类（直流电机抽象）。3 个虚方法 + 2 个回调，
  *          覆盖直流电机能做的全部事情：
  *
  ...
  *
  *          这跟 h_motor_base 的 24 个虚方法形成强烈对照——证明
  *          ops 表的规模严格匹配硬件能力，不是"越多越好"也不是
  *          "为了对称勉强凑数"。
  ******************************************************************************
  */
