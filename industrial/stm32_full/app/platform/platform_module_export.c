...
/*
 * platform_module_export.c - 8 级 initcall dispatcher.
 *
...
#define MODULE_EXPORT_EXEC(section)                                           \
	do                                                                        \
	{                                                                         \
		struct module_export *p_module_export_base;                           \
		uint32_t module_export_count;                                         \
		p_module_export_base = (struct module_export *)(&section##$$Base);    \
		module_export_count = ((unsigned int)(&section##$$Limit)              \
		                        - (unsigned int)(&section##$$Base))           \
		                        / sizeof(struct module_export);               \
...
#define MODULE_EXPORT_EXEC(section)                                           \
	...
	{                                                                         \
		...
		p_module_export_base =                                                \
			(struct module_export *)(__section_begin(#section));              \
...
#define MODULE_EXPORT_EXEC(section)                                           \
	...
	{                                                                         \
		...
		uint32_t module_export_count;                                         \
		p_module_export_base =                                                \
			(struct module_export *)(&moduleExport##section##_start);         \
		module_export_count =                                                 \
